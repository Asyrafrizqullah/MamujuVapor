...
<body>
  ...
  <section class="container">
    <div class="card mb-3 border-0 text-center">
      ...
      <div class="card-body">
        <h1 class="card-title fw-bold text-center">Pesan barang, ga pake ribet!</h1>
  ...
  <main class="container" style="margin-top: 100px;">
    <div class="card" style="background-color: #f5f5f5; height: 500px; border-radius: 30px; border: 0cm;">
      ...
      <a href="daftar-hotel.php" class="btn btn-warning btn-lg my-5" style="  width: 210px;
        border-radius: 12px;
        margin-left: 445px">Lihat Produk</a>
    </div>
  </main>

  <main class="container">
    <h1 class="fw-bold" style="margin-top: 90px;">Diskon Saat Ini</h1>
    <div class="row">
      <div class="col-4">
        <div class="card-body">
          <?php
          ...
          while ($data = mysqli_fetch_array($diskonKamar)) { ?>
            ...
            <del>
              <h3 class="card-text text-danger my-1">Rp <?= number_format($data['hargaKamar']) ?></h3>
            </del>
  ...
  <div class="container" style="margin-top: 100px;">
    ...
    <div class="card col-12" style="background-color: #f5f5f5; border-radius: 30px; ">
      <h1 class="about-title ml-3" style="margin-top: 42px; font-size: 36px; font-weight: bold; ">Mamuju Vapor
        Promoso</h1>
